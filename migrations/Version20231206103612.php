 ...
 */
final class Version20231206103612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE country country VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE country country VARCHAR(150) NOT NULL');
    }
}
